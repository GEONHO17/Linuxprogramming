...
void Shape::Shape(int x,int y){  //멤버 변수 설정함수    
...
void Circle::Circle(int x,int y,int rad):Shape(x,y){ //멤버 변수 설정함수
...
void Rect::Rect(int x,int y,int width,int height):Shape(x,y){  //멤버 변수 설정 함수 
...
void Triangle:: Triangle(int x,int y,int width,int height):Shape(x,y){  //멤버 변수 설정함수
    this -> width = width;      //입력받은 값 width로 설정
